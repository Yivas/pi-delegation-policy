...
- State the advisor's current evidence ceiling: no packed end-to-end harness covers its plain-text path yet, so its launch contract is checked only against a simulated preflight, never a real executor response.
