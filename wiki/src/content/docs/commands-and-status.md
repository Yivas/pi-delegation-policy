...
| `D:ORCH` | A valid `orchestrator` configuration is active.              | Published `0.8.0`: delegate all transferable execution first; retain final acceptance. Published `0.7.0` retains its permissive historical policy. |
